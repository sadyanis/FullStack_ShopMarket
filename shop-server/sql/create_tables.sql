...
DROP TABLE IF EXISTS products_localized_product CASCADE;
DROP TABLE IF EXISTS localized_product CASCADE;
...
CREATE INDEX idx_products_categories_prod ON products_categories(product_id);
CREATE INDEX idx_products_categories_cat ON products_categories(category_id);
CREATE INDEX idx_products_loc_prod ON products_localized_product(product_id);
CREATE INDEX idx_products_loc_loc ON products_localized_product(localized_product_id);
CREATE INDEX idx_shops_opening_shop ON shops_opening_hours(shop_id);
CREATE INDEX idx_shops_opening_oh ON shops_opening_hours(opening_hours_id);